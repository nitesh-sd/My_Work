...
public class JTCAppConfig {
	 ...
	 */
//Case 1 --> When no matching Bean is found
	/*
	 * @Bean("myhai1") public Hai createHai1() { Hai hai = new Hai();
	 * hai.setMsg("I am in Hai"); return hai; }
	 * 
	 * @Bean("myhai2") public Hai createHai2() { Hai hai = new Hai();
	 * hai.setMsg("I am in Hai"); return hai; }
	 */
